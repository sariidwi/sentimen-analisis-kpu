...
stopwords_indonesia = set([
    ...
    "test", "coba", "tes", "uh", "uhm", "hmm", "kenapa", "tapi", "bahkan", "mungkin", "entah", "kalau", "tp", "klo", "karna", "bbrpa", "urusanmu",
     "jadi", "juga", "mah", "aja",  "seperti", "masih", "pada", "mau", "mana", "lamuuuuu", "hehehe", "eh", " ", "kayak", "kaya", "lah"
     "klo", "ky", "gw", "aja", "gini", "gk", "ga", "g", "ny", "mah", "ne", "donwlod",
    "dong", "loh", "lah", "wah", "aja", "nih", "deh", "yok", "josss", "🤣", "😅", "😭", "wak",
    "🙏", "✌️", "😝", "🔥", "😋", "ampas", "konttoll", "rungkad", "parah", "buruk",
    "jelekk", "gbk", "sialan", "buosokkk", "josss", "mau", "ya", "iya", "pemirsa", "h", "v",
    "no", "yes", "wkwk", "wkwkwk", "haha", "huhu", "hehe", "anjay", "gak", "nyusahi",
    "nyusahin", "nyusahke", "rausah", "durung", "nek", "kok", "tok", "aja", "lagi",
    "gitu", "begitu", "gimana", "kayak", "seperti", "udah", "nggak", "ngga", "banget",
    "cuman", "cumann", "aja", "kayanya", "masak", "kaya", "kayak", "gitu", "dek", "donk",
